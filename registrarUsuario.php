        ...
        <div class="card mi-card" >
          <div class="card-body">
            ...
            <form method="post" autocomplete="off">
              ...
              <!-- alerta -->
              <div class="form-group col-sm-12">
                <div class="mi-alerta alert small alert-success" role="alert">
                  <span><?php echo $datos; ?></span>
                </div>
              </div>
              
              <?php endif ?>

              <button type="submit" class="btn mi-boton col-sm-12">Registrarse</button>
              <a href="http://localhost/sesion_login_php/" class="btn text-info col-sm-12">Iniciar Sesion</a>
